...
public class TiendaDeAlquiler implements Serializable{
	...
	public boolean aniadir(String id, String titulo, int anio, String descripcion,
			String autor, int numeroPaginas, GeneroEditorial genero,
			boolean bestseller) throws IdNoValidoException, NumeroPaginasNoValidoException, 
		...
		Producto producto = new Libro(id, titulo, anio, descripcion, autor, numeroPaginas, genero, bestseller);
	...
	public boolean aniadir(String id, String titulo, int anio, String descripcion,
			...
			AnioNoValidoException, DescripcionNoValidaException, ProductoYaExisteException{
		Producto producto = new Pelicula(id, titulo, anio, descripcion, director, duracion, genero, oscar);
		if(tiendaDeAlquiler.contains(producto))
			throw new ProductoYaExisteException("El producto ya existe!");
		return tiendaDeAlquiler.add(producto);
	...
	public boolean aniadir(String id, String titulo, int anio, String descripcion,
			...
			AnioNoValidoException, DescripcionNoValidaException, ProductoYaExisteException{
		Producto producto = new Musica(id, titulo, anio, descripcion, interprete, numeroCanciones, genero, grammy);
		if(tiendaDeAlquiler.contains(producto))
			throw new ProductoYaExisteException("El producto ya existe!");
		return tiendaDeAlquiler.add(producto);
	}
	...
	/**
	 * Crea una lista de productos de un género determinado.
	 * 
	 * @param genero
	 * 			Género a buscar
	 * @param tipo
	 ...
	 */
	public ArrayList<Producto> getGenero(GeneroCinematografico generoCinematografico, GeneroEditorial generoEditorial, TipoProducto tipo){
